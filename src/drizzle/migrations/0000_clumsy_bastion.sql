...
CREATE TABLE IF NOT EXISTS "country_group_discounts" (
	...
	"dicount_percentage" real NOT NULL,
...
CREATE TABLE IF NOT EXISTS "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT 'Hi! It looks like you are from <b>{country}</b>. We support Parity Purchasing Power. If you need it, use code <b>"{coupon}"</b> to get <b>{discount}%</b> off.' NOT NULL,
...
CREATE INDEX IF NOT EXISTS "user_subscriptions.clerk_user_id_index" ON "user_subscription" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_subscriptions.stripe_customer_id_index" ON "user_subscription" USING btree ("stripe_customer_id");