...
export function getUserSubsciption(userId: string) {
  const cacheFn = dbCache(getUserSubsciptionInternal, {
...
export async function getUserSubscriptionTier(userId: string) {
  const subscription = await getUserSubsciption(userId)
...
function getUserSubsciptionInternal(userId: string) {
